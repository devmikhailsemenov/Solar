...
/**
 * Класс, методы которого позволяют выделять активные пункты меню, когда соотв. якорной ссылке
 * секция попадает в область видимости окна, создавать плавный скролл к нужной секции при клике
 * на пункт меню.
 */
export class Navbar {
